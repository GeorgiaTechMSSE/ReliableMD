...
void Thermo::parse_fields(char *str)
{
  ...
  while (word) {
    ...
    /* ------------------------------------------------- */
    // add rad
    } else if (strcmp(word,"pxxrad") == 0) {
      addfield("Pxxrad",&Thermo::compute_pxxrad,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pyyrad") == 0) {
      addfield("Pyyrad",&Thermo::compute_pyyrad,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pzzrad") == 0) {
      addfield("Pzzrad",&Thermo::compute_pzzrad,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pxyrad") == 0) {
      addfield("Pxyrad",&Thermo::compute_pxyrad,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pxzrad") == 0) {
      addfield("Pxzrad",&Thermo::compute_pxzrad,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pyzrad") == 0) {
      addfield("Pyzrad",&Thermo::compute_pyzrad,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pxxub") == 0) {
      addfield("Pxxub",&Thermo::compute_pxxub,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pyyub") == 0) {
      addfield("Pyyub",&Thermo::compute_pyyub,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pzzub") == 0) {
      addfield("Pzzub",&Thermo::compute_pzzub,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pxyub") == 0) {
      addfield("Pxyub",&Thermo::compute_pxyub,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pxzub") == 0) {
      addfield("Pxzub",&Thermo::compute_pxzub,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pyzub") == 0) {
      addfield("Pyzub",&Thermo::compute_pyzub,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pxxlb") == 0) {
      addfield("Pxxlb",&Thermo::compute_pxxlb,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pyylb") == 0) {
      addfield("Pyylb",&Thermo::compute_pyylb,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pzzlb") == 0) {
      addfield("Pzzlb",&Thermo::compute_pzzlb,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pxylb") == 0) {
      addfield("Pxylb",&Thermo::compute_pxylb,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pxzlb") == 0) {
      addfield("Pxzlb",&Thermo::compute_pxzlb,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    } else if (strcmp(word,"pyzlb") == 0) {
      addfield("Pyzlb",&Thermo::compute_pyzlb,FLOAT);
      index_press_vector = add_compute(id_press,VECTOR);
    /* ------------------------------------------------- */
...
/* ---------------------------------------------------------------------- */
// add rad
void Thermo::compute_pxxrad()
{
  dvalue = pressure->vectorrad[0]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pyyrad()
{
  dvalue = pressure->vectorrad[1]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pzzrad()
{
  dvalue = pressure->vectorrad[2]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pxyrad()
{
  dvalue = pressure->vectorrad[3]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pxzrad()
{
  dvalue = pressure->vectorrad[4]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pyzrad()
{
  dvalue = pressure->vectorrad[5]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pxxub()
{
  dvalue = pressure->vector_ub[0]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pyyub()
{
  dvalue = pressure->vector_ub[1]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pzzub()
{
  dvalue = pressure->vector_ub[2]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pxyub()
{
  dvalue = pressure->vector_ub[3]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pxzub()
{
  dvalue = pressure->vector_ub[4]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pyzub()
{
  dvalue = pressure->vector_ub[5]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pxxlb()
{
  dvalue = pressure->vector_lb[0]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pyylb()
{
  dvalue = pressure->vector_lb[1]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pzzlb()
{
  dvalue = pressure->vector_lb[2]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pxylb()
{
  dvalue = pressure->vector_lb[3]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pxzlb()
{
  dvalue = pressure->vector_lb[4]; // see computer_pressure.cpp for 3d implementation
}
void Thermo::compute_pyzlb()
{
  dvalue = pressure->vector_lb[5]; // see computer_pressure.cpp for 3d implementation
}
/* ---------------------------------------------------------------------- */
