...
class Compute : protected Pointers {
 public:
  ...
  /* --------------------------------------------------------------------- */
  double scalar_ub;         // scalar upperbound
  double scalar_lb;         // scalar lowerbound
  double *vectorrad;        // add rad; computed global rad vector
  double *vector_ub;        // add rad; computed global rad vector
  double *vector_lb;        // add rad; computed global rad vector
  /* --------------------------------------------------------------------- */
  ...
  /* --------------------------------------------------------------------- */
  virtual double compute_scalar_ub() {return 0.0;}    // add compute_scalar upperbound 
  virtual double compute_scalar_lb() {return 0.0;}    // add compute_scalar lowerbound
  /* --------------------------------------------------------------------- */
