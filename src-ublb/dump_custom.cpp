...
enum{ID,MOL,TYPE,ELEMENT,MASS,
     ...
     XRAD,YRAD,ZRAD,VXRAD,VYRAD,VZRAD, FXRAD, FYRAD, FZRAD, // add rad
     XUB,YUB,ZUB,VXUB,VYUB,VZUB, FXUB, FYUB, FZUB, // add UB
     XLB,YLB,ZLB,VXLB,VYLB,VZLB, FXLB, FYLB, FZLB, // add LB
...
int DumpCustom::count()
{
  ...
  if (nthresh) {
    ...
    for (int ithresh = 0; ithresh < nthresh; ithresh++) {
      ...
      /* ------------------------------------- */
      // add rad
      } else if (thresh_array[ithresh] == XRAD) {
        ptr = &atom->xrad[0][0];
        nstride = 3;
      } else if (thresh_array[ithresh] == YRAD) {
        ptr = &atom->xrad[0][1];
        nstride = 3;
      } else if (thresh_array[ithresh] == ZRAD) {
        ptr = &atom->xrad[0][2];
        nstride = 3;
       } else if (thresh_array[ithresh] == VXRAD) {
        ptr = &atom->vrad[0][0];
        nstride = 3;
      } else if (thresh_array[ithresh] == VYRAD) {
        ptr = &atom->vrad[0][1];
        nstride = 3;
      } else if (thresh_array[ithresh] == VZRAD) {
        ptr = &atom->vrad[0][2];
        nstride = 3;
      } else if (thresh_array[ithresh] == FXRAD) {
        ptr = &atom->frad[0][0];
        nstride = 3;
      } else if (thresh_array[ithresh] == FYRAD) {
        ptr = &atom->frad[0][1];
        nstride = 3;
      } else if (thresh_array[ithresh] == FZRAD) {
        ptr = &atom->frad[0][2];
        nstride = 3;
      // add ub
      } else if (thresh_array[ithresh] == XUB) {
        ptr = &atom->xub[0][0];
        nstride = 3;
      } else if (thresh_array[ithresh] == YUB) {
        ptr = &atom->xub[0][1];
        nstride = 3;
      } else if (thresh_array[ithresh] == ZUB) {
        ptr = &atom->xub[0][2];
        nstride = 3;
       } else if (thresh_array[ithresh] == VXUB) {
        ptr = &atom->vub[0][0];
        nstride = 3;
      } else if (thresh_array[ithresh] == VYUB) {
        ptr = &atom->vub[0][1];
        nstride = 3;
      } else if (thresh_array[ithresh] == VZUB) {
        ptr = &atom->vub[0][2];
        nstride = 3;
      } else if (thresh_array[ithresh] == FXUB) {
        ptr = &atom->fub[0][0];
        nstride = 3;
      } else if (thresh_array[ithresh] == FYUB) {
        ptr = &atom->fub[0][1];
        nstride = 3;
      } else if (thresh_array[ithresh] == FZUB) {
        ptr = &atom->fub[0][2];
        nstride = 3;  
      // add lb
      } else if (thresh_array[ithresh] == XLB) {
        ptr = &atom->xlb[0][0];
        nstride = 3;
      } else if (thresh_array[ithresh] == YLB) {
        ptr = &atom->xlb[0][1];
        nstride = 3;
      } else if (thresh_array[ithresh] == ZLB) {
        ptr = &atom->xlb[0][2];
        nstride = 3;
       } else if (thresh_array[ithresh] == VXLB) {
        ptr = &atom->vlb[0][0];
        nstride = 3;
      } else if (thresh_array[ithresh] == VYLB) {
        ptr = &atom->vlb[0][1];
        nstride = 3;
      } else if (thresh_array[ithresh] == VZLB) {
        ptr = &atom->vlb[0][2];
        nstride = 3;
      } else if (thresh_array[ithresh] == FXLB) {
        ptr = &atom->flb[0][0];
        nstride = 3;
      } else if (thresh_array[ithresh] == FYLB) {
        ptr = &atom->flb[0][1];
        nstride = 3;
      } else if (thresh_array[ithresh] == FZLB) {
        ptr = &atom->flb[0][2];  
      /* ------------------------------------- */
...
int DumpCustom::parse_fields(int narg, char **arg)
{
  ...
  for (int iarg = 5; iarg < narg; iarg++) {
    ...
    /* ---------------------------------------- */
    // add rad 
    } else if (strcmp(arg[iarg],"xrad") == 0) {
      pack_choice[i] = &DumpCustom::pack_xrad;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"yrad") == 0) {
      pack_choice[i] = &DumpCustom::pack_yrad;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"zrad") == 0) {
      pack_choice[i] = &DumpCustom::pack_zrad;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vxrad") == 0) {
      pack_choice[i] = &DumpCustom::pack_vxrad;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vyrad") == 0) {
      pack_choice[i] = &DumpCustom::pack_vyrad;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vzrad") == 0) {
      pack_choice[i] = &DumpCustom::pack_vzrad;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fxrad") == 0) {
      pack_choice[i] = &DumpCustom::pack_fxrad;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fyrad") == 0) {
      pack_choice[i] = &DumpCustom::pack_fyrad;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fzrad") == 0) {
      pack_choice[i] = &DumpCustom::pack_fzrad;
      vtype[i] = DOUBLE;
    // add ub
    } else if (strcmp(arg[iarg],"xub") == 0) {
      pack_choice[i] = &DumpCustom::pack_xub;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"yub") == 0) {
      pack_choice[i] = &DumpCustom::pack_yub;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"zub") == 0) {
      pack_choice[i] = &DumpCustom::pack_zub;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vxub") == 0) {
      pack_choice[i] = &DumpCustom::pack_vxub;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vyub") == 0) {
      pack_choice[i] = &DumpCustom::pack_vyub;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vzub") == 0) {
      pack_choice[i] = &DumpCustom::pack_vzub;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fxub") == 0) {
      pack_choice[i] = &DumpCustom::pack_fxub;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fyub") == 0) {
      pack_choice[i] = &DumpCustom::pack_fyub;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fzub") == 0) {
      pack_choice[i] = &DumpCustom::pack_fzub;
      vtype[i] = DOUBLE;
    // add lb
    } else if (strcmp(arg[iarg],"xlb") == 0) {
      pack_choice[i] = &DumpCustom::pack_xlb;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"ylb") == 0) {
      pack_choice[i] = &DumpCustom::pack_ylb;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"zlb") == 0) {
      pack_choice[i] = &DumpCustom::pack_zlb;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vxlb") == 0) {
      pack_choice[i] = &DumpCustom::pack_vxlb;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vylb") == 0) {
      pack_choice[i] = &DumpCustom::pack_vylb;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vzlb") == 0) {
      pack_choice[i] = &DumpCustom::pack_vzlb;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fxlb") == 0) {
      pack_choice[i] = &DumpCustom::pack_fxlb;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fylb") == 0) {
      pack_choice[i] = &DumpCustom::pack_fylb;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fzlb") == 0) {
      pack_choice[i] = &DumpCustom::pack_fzlb;
      vtype[i] = DOUBLE;
    /* ---------------------------------------- */
...
int DumpCustom::modify_param(int narg, char **arg)
{
  ...
  if (strcmp(arg[0],"thresh") == 0) {
    ...
    /* ----------------------------------------------------------- */
    // add rad
    else if (strcmp(arg[1],"xrad") == 0) thresh_array[nthresh] = XRAD;
    else if (strcmp(arg[1],"yrad") == 0) thresh_array[nthresh] = YRAD;
    else if (strcmp(arg[1],"zrad") == 0) thresh_array[nthresh] = ZRAD;
    else if (strcmp(arg[1],"vxrad") == 0) thresh_array[nthresh] = VXRAD;
    else if (strcmp(arg[1],"vyrad") == 0) thresh_array[nthresh] = VYRAD;
    else if (strcmp(arg[1],"vzrad") == 0) thresh_array[nthresh] = VZRAD;
    else if (strcmp(arg[1],"fxrad") == 0) thresh_array[nthresh] = FXRAD;
    else if (strcmp(arg[1],"fyrad") == 0) thresh_array[nthresh] = FYRAD;
    else if (strcmp(arg[1],"fzrad") == 0) thresh_array[nthresh] = FZRAD;
    // add ub
    else if (strcmp(arg[1],"xub") == 0) thresh_array[nthresh] = XUB;
    else if (strcmp(arg[1],"yub") == 0) thresh_array[nthresh] = YUB;
    else if (strcmp(arg[1],"zub") == 0) thresh_array[nthresh] = ZUB;
    else if (strcmp(arg[1],"vxub") == 0) thresh_array[nthresh] = VXUB;
    else if (strcmp(arg[1],"vyub") == 0) thresh_array[nthresh] = VYUB;
    else if (strcmp(arg[1],"vzub") == 0) thresh_array[nthresh] = VZUB;
    else if (strcmp(arg[1],"fxub") == 0) thresh_array[nthresh] = FXUB;
    else if (strcmp(arg[1],"fyub") == 0) thresh_array[nthresh] = FYUB;
    else if (strcmp(arg[1],"fzub") == 0) thresh_array[nthresh] = FZUB;
    // add lb
    else if (strcmp(arg[1],"xlb") == 0) thresh_array[nthresh] = XLB; 
    else if (strcmp(arg[1],"ylb") == 0) thresh_array[nthresh] = YLB;
    else if (strcmp(arg[1],"zlb") == 0) thresh_array[nthresh] = ZLB;
    else if (strcmp(arg[1],"vxlb") == 0) thresh_array[nthresh] = VXLB;
    else if (strcmp(arg[1],"vylb") == 0) thresh_array[nthresh] = VYLB;
    else if (strcmp(arg[1],"vzlb") == 0) thresh_array[nthresh] = VZLB;
    else if (strcmp(arg[1],"fxlb") == 0) thresh_array[nthresh] = FXLB;
    else if (strcmp(arg[1],"fylb") == 0) thresh_array[nthresh] = FYLB;
    else if (strcmp(arg[1],"fzlb") == 0) thresh_array[nthresh] = FZLB;
    /* ----------------------------------------------------------- */
...
// add rad
void DumpCustom::pack_xrad(int n)
{
  double **xrad = atom->xrad;

  for (int i = 0; i < nchoose; i++) {
    buf[n] = xrad[clist[i]][0];
    n += size_one;
  }
}
void DumpCustom::pack_yrad(int n)
{
  double **xrad = atom->xrad;

  for (int i = 0; i < nchoose; i++) {
    buf[n] = xrad[clist[i]][1];
    n += size_one;
  }
}
void DumpCustom::pack_zrad(int n)
{
  double **xrad = atom->xrad;

  for (int i = 0; i < nchoose; i++) {
    buf[n] = xrad[clist[i]][2];
    n += size_one;
  }
}
void DumpCustom::pack_vxrad(int n)
{
  double **vrad = atom->vrad;

  for (int i = 0; i < nchoose; i++) {
    buf[n] = vrad[clist[i]][0];
    n += size_one;
  }
}
void DumpCustom::pack_vyrad(int n)
{
  double **vrad = atom->vrad;

  for (int i = 0; i < nchoose; i++) {
    buf[n] = vrad[clist[i]][1];
    n += size_one;
  }
}
void DumpCustom::pack_vzrad(int n)
{
  double **vrad = atom->vrad;

  for (int i = 0; i < nchoose; i++) {
    buf[n] = vrad[clist[i]][2];
    n += size_one;
  }
}
void DumpCustom::pack_fxrad(int n)
{
  double **frad = atom->frad;

  for (int i = 0; i < nchoose; i++) {
    buf[n] = frad[clist[i]][0];
    n += size_one;
  }
}
void DumpCustom::pack_fyrad(int n)
{
  double **frad = atom->frad;

  for (int i = 0; i < nchoose; i++) {
    buf[n] = frad[clist[i]][1];
    n += size_one;
  }
}
void DumpCustom::pack_fzrad(int n)
{
  double **frad = atom->frad;

  for (int i = 0; i < nchoose; i++) {
    buf[n] = frad[clist[i]][2];
    n += size_one;
  }
}
// add ub
void DumpCustom::pack_xub(int n)
{
  double **xub = atom->xub;
...
void DumpCustom::pack_yub(int n)
{
  double **xub = atom->xub;
...
void DumpCustom::pack_zub(int n)
{
  double **xub = atom->xub;
...
void DumpCustom::pack_vxub(int n)
{
  double **vub = atom->vub;
...
void DumpCustom::pack_vyub(int n)
{
  double **vub = atom->vub;
...
void DumpCustom::pack_vzub(int n)
{
  double **vub = atom->vub;
...
void DumpCustom::pack_fxub(int n)
{
  double **fub = atom->fub;
...
void DumpCustom::pack_fyub(int n)
{
  double **fub = atom->fub;
...
void DumpCustom::pack_fzub(int n)
{
  double **fub = atom->fub;
...
// add lb
void DumpCustom::pack_xlb(int n)
{
  double **xlb = atom->xlb;
...
void DumpCustom::pack_ylb(int n)
{
  double **xlb = atom->xlb;
...
void DumpCustom::pack_zlb(int n)
{
  double **xlb = atom->xlb;
...
void DumpCustom::pack_vxlb(int n)
{
  double **vlb = atom->vlb;
...
void DumpCustom::pack_vylb(int n)
{
  double **vlb = atom->vlb;
...
void DumpCustom::pack_vzlb(int n)
{
  double **vlb = atom->vlb;
...
void DumpCustom::pack_fxlb(int n)
{
  double **flb = atom->flb;
...
void DumpCustom::pack_fylb(int n)
{
  double **flb = atom->flb;
...
void DumpCustom::pack_fzlb(int n)
{
  double **flb = atom->flb;
