...
class Pair : protected Pointers {
 ...
 public:
  ...
  // add rad
  double virialrad[6];           // accumulated virial uncertainty associated with virial
  double virial_ub[6];
  double virial_lb[6];
  int ub_reset_flag;             // pair_eam_rad.h/.cpp: if 1 then reset
  int lb_reset_flag;             // pair_eam_rad.h/.cpp: if 1 then reset
  ...
  // add rad
  void ev_tallyrad(int, int, int, int, double, double, double,
                double, double, double, double, double, double, double);
  void ev_tally_ub(int, int, int, int, double, double, double,
                double, double, double);
  void ev_tally_lb(int, int, int, int, double, double, double,
                double, double, double);
  void update_virial_rad();
 ...
 protected:
  ...
  // add rad
  void virial_ub_fdotr_compute();
  void virial_lb_fdotr_compute();
  virtual void ev_setup_ub(int, int);
  virtual void ev_setup_lb(int, int);
