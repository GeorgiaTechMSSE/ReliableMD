...
struct plssconfig {
  ...
  real  epsVer;         /*! The Epsilon used for the epsilon inflation during the the verification step. The default is 0.1 */
  real  epsRef;         /*! Sets the stopping criterion for the refinement step. If two successive iterates do not differ by more than epsRef,
