...
/*
** Example program for complex interval systems. 
**
...
//Function defining A
void makeA(int i, int j, cinterval& r) {
...
int main (int argc, char** argv)
{
  ...
  pcilss(A,b,x,m,n,np,myid,Err,out,cfg);
  //Version 2 using function pointers to define A and b (allowing larger systems)
  //pcilss(makeA,makeb,x,m,n,rhs,np,myid,Err,out,cfg);
  end = GetTime();
