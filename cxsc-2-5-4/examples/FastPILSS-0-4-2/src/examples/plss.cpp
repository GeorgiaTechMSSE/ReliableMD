...
/*
** Example program for real point systems. 
**
...
int main (int argc, char** argv)
{
  ...
  plss(A,b,x,m,n,np,myid,Err,out,cfg);
  //Version 2 using function pointers to define A and b (allowing larger systems)
  //plss(makeA,makeb,x,m,n,rhs,np,myid,Err,out,cfg);
  end = GetTime();
