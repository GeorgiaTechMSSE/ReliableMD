...
Atom::Atom(LAMMPS *lmp) : Pointers(lmp)
{
  ...
  image = NULL;
  x = v = f = NULL;
  xrad = vrad = frad = NULL; // add rad
  xub = xlb = NULL; // add rad
  vub = vlb = NULL; // add rad
  fub = flb = NULL; // add rad
  ...
  xrad_flag = vrad_flag = frad_flag = 0;
...
void *Atom::extract(char *name)
{
  ...
  if (strcmp(name,"xrad") == 0) return (void *) xrad;
  if (strcmp(name,"xub") == 0) return (void *) xub;
  if (strcmp(name,"xlb") == 0) return (void *) xlb;
  if (strcmp(name,"vrad") == 0) return (void *) vrad;
  if (strcmp(name,"vub") == 0) return (void *) vub;
  if (strcmp(name,"vlb") == 0) return (void *) vlb;
  if (strcmp(name,"frad") == 0) return (void *) frad;
  if (strcmp(name,"fub") == 0) return (void *) flb;
  if (strcmp(name,"flb") == 0) return (void *) fub;
